...
int main(int argc, char *argv[])
{
  ...
  for (int k=0; k<4; k++) {
    ...
    double total_flops = 2.0*global_nonzero_count *((double) maxtrials) * ((double) nrhs);
...
#pragma omp parallel
  ...
  if (makeheader) 
    cout << "Metric_\t\t_Ranks_\t_Thrds_\t__SpMV__\t_SpMM2__\t_SpMM4__\t_SpMM8__\t__NORM___\t__DOT___\t__AXPY__" << endl;
  if (comm.MyPID()==0) {
